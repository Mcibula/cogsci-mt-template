...
Typing standard keyboard double quotes (e.g., \verb|"text"|) in \LaTeX{} usually result in poorly formatted,
...
within them remains selectable and legible.\footnote{Make sure to also use an appropriate font size in your figures,
...
graphic software or plotting library. In the case of photos, JPEG or PNG is fine.
...
and \verb|r| for alignment to the right). In the table, you separate columns with \verb|&| and lines
with \verb|\\|; any spacing around them is ignored. You usually do not need to input a table manually, as there are many
