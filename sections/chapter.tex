...
Bib\LaTeX{} is slightly more advanced, and since it allows us to use the full APA style for references,
this template uses Bib\LaTeX{}.
...
document. The rest of the fields provide details about the publication. You can provide many more fields
...
in the text will be rendered in the bibliography. Moreover, the references can be in any order in the file;
Bib\LaTeX{} will sort the used ones according to the used bibliography style.
...
\end{verbatim}
    ...
    \item For the \verb|date| field, leave just the year.
    ...
    \verb|doi.org/|, or \verb|https://doi.org/|. With the APA style, the DOI is the preferred identifier;
